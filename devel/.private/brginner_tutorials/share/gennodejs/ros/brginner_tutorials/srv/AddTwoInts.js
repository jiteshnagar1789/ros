...
// (in-package brginner_tutorials.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'brginner_tutorials/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'brginner_tutorials/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'brginner_tutorials/AddTwoInts'; }
};
